...
// 	}
	...
	public function frmPopupLandblog(){
		...
		$tr = Application_Form_FrmLanguages::getCurrentlanguage();
		$str='<div class="dijitHidden">
		<div data-dojo-type="dijit.Dialog"  id="frm_customer" >
		...
		$str.='<table style="margin: 0 auto; width: 100%;" cellspacing="7">
		<tr>
			<td colspan="6" style="border-bottom: solid 1px #ccc;">'.$tr->translate("CLIENT").'</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="6" style="border-bottom: solid 1px #ccc;">'.$tr->translate("RELEVANT_STAKEHOLDER").'</td>
		</tr>
		<tr>
