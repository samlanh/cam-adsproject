...
//     	echo$sql.$where.$order;
    ...
    function addNewstore($data){
    	...
    	try{
    		...
    		$arr = array(
    				'store_id'   =>$store_id,
    				"store_title"   =>$data['ads_code'],
    				"store_email"   =>$data['ads_code'],
    				"banner_home"   =>$data['ads_code'],
    				"alias_store"   =>$data['ads_code'],
    				"banner_detail"   =>$data['ads_code'],
    				"client_id"   =>$data['ads_code'],
    				"template_id"   =>$data['ads_code'],
    				"logo_store"   =>$data['ads_code'],
    				"store_phone"   =>$data['ads_code'],
    				"store_policy"   =>$data['ads_code'],
