...
// 						'position' => '',
			...
			$this->view->list=$list->getCheckList(3, $collumns,$rs_rows,array('branch_name'=>$link,'co_code'=>$link,'co_khname'=>$link,'co_engname'=>$link));
		}catch (Exception $e){
   ...
   function deleteAction(){
   	...
   	if (!empty($id)){
   		try{
   			$db->deleteStaff($id);
   			Application_Form_FrmMessage::Sucessfull('DELETE_SUCCESS',"/group/co");
   		}catch (Exception $e){
