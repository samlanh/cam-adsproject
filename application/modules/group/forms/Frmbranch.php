...
// 				'readOnly'=>'readOnly',
		...
		$branch_note->setAttribs(array(
				'dojoType'=>'dijit.form.TextBox',
				'class'=>'fullside',
				'style'=>'width:100%;min-height:60px;font-family: Helvetica,sans-serif,"Kh Battambang","Khmer Battambang";'
// 				'readonly'=>true
				));
...
// 				'readonly'=>true
		...
		$regiser_by = new Zend_Dojo_Form_Element_TextBox('register_by');
		$regiser_by->setAttribs(array(
				'dojoType'=>'dijit.form.TextBox',
				'class'=>'fullside',
		));
		...
		if(!empty($data)){
			...
			$regiser_by->setValue($data['register_by']);
		...
		$branch_nameen,$br_address,$branch_code,$branch_tel,$_fax ,$branch_note,
				...
				$branch_status,$branch_display,$_issue_date,$credentail_no,$regiser_by,));
